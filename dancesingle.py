            ...
            for c in range(note[a][b].count('1')+note[a][b].count('2')+note[a][b].count('4')): # gets all arrows
                ...
                if random:
                    ...
                    if p == 'normal': # to do: put all of these in functions to reduce redundant code
                        ...
                        if leftfoot and R not in fullholdlist and R not in nextlist:
                            next = [R]
                        elif leftfoot: # do left again
                            if R == 0: # go back to last arrow
                                if L not in nextlist:
                                    next = [L]
                                else:
                                ...
                                if R in next:
                                    next.remove(R)
                        elif not leftfoot and L not in fullholdlist and L not in nextlist:
                            next = [L]
                        else: # right again
                            if L == 3:  # go back to last arrow
                                if R not in nextlist:
                        ...
                        if leftfoot and L not in fullholdlist and L not in nextlist:
                            next = [L]
                        elif leftfoot: # do left again
                            if R == 0: # go back to last arrow
                                if L not in nextlist:
                                ...
                                if R in next:
                                    next.remove(R)
                        elif not leftfoot and R not in fullholdlist and R not in nextlist:
                            next = [R]
                        else: # right again
                            if L == 3:  # go back to last arrow
                                if R not in nextlist:
